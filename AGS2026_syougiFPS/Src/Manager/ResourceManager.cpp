...
void ResourceManager::Init(void)
{
	...
	res = new RES(RES_T::IMG, PATH_IMG + "難易度.png");
	resourcesMap_.emplace(SRC::Select, res);

	res = new RES(RES_T::IMG, PATH_IMG + "操作.png");
	resourcesMap_.emplace(SRC::Control, res);

	res = new RES(RES_T::IMG, PATH_IMG + "矢印.png");
	resourcesMap_.emplace(SRC::Cursor, res);

	res = new RES(RES_T::IMG, PATH_IMG + "決定.png");
	resourcesMap_.emplace(SRC::Decision, res);

	res = new RES(RES_T::IMG, PATH_IMG + "簡単.png");
	resourcesMap_.emplace(SRC::Easy, res);

	res = new RES(RES_T::IMG, PATH_IMG + "普通.png");
	resourcesMap_.emplace(SRC::Normal, res);

	res = new RES(RES_T::IMG, PATH_IMG + "難しい.png");
